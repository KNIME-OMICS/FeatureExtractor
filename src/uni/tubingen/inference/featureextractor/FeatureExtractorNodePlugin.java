 ...
 * @author enrique
 */
public class FeatureExtractorNodePlugin extends Plugin {
    // The shared instance.
    private static FeatureExtractorNodePlugin plugin;

    /**
     * The constructor.
     */
    public FeatureExtractorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static FeatureExtractorNodePlugin getDefault() {
        return plugin;
    }
